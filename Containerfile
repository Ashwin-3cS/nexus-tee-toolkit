...
# Build nexus-tool with AWS NSM support
WORKDIR /src/nexus-tool
...
RUN cp /src/nexus-tool/target/${TARGET}/release/nexus_tool initramfs/
RUN cp /src/nexus-tool/run.sh initramfs/
